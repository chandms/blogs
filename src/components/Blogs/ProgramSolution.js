...
export default function ProgramSolution(props){
    return (
        ...
        <div className='h-24 bg-gradient-to-r from-purple-500 to-pink-500" flex flex-col flex-wrap justify-center shadow-lg'>
            ...
            className="inline-flex m-auto items-center underline text-blue-800 border-0 py-1 px-2 focus:outline-none hover:bg-blue-700 rounded hover:text-white text-base mt-4 md:mt-0">
            Leetcode Link
